...
public class DemoEmployee {
    ...
    public static void main(String[] args) {
        ...
        emp3.whoAmI(); 
        // emp3.whoAmI() // prints "part-time employee" because emp3 refers to an object of PartTimeEmployee
        // emp3.getHourlyRate(); // returns syntax error because the method getHourlyRate() is not defined in the Employee class

        // TODO Add the condition that test that emp3 is an instance of part time employee at this time
		...
		// This instruction returns a ClassCastException at runtime
        // because emp1 is not a PartTimeEmployee, so it cannot be cast to that type.

        // Downcasting 2
        // Requires the use of intance to avoid a run time cast exception
